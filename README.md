...
Cloud in a Bottle runs on your own hardware, a local virtual machine, or a cloud server. Follow the [deployment guide](https://cloudinabottle.org/docs/#for-owners) to install it.
...
- [Deploying Cloud in a Bottle](https://cloudinabottle.org/docs/#for-owners)
