...
from compute_space.db.versioned.migrations.v0015_dns_records import Migration0015DnsRecords
from compute_space.db.versioned.migrations.v0016_dns_zones import Migration0016DnsZones
...
REGISTRY: list[Migration] = [
    ...
    Migration0015DnsRecords(),
    Migration0016DnsZones(),
]
