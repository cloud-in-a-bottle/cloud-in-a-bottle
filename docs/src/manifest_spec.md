...
Apps declare how they should be deployed on Cloud in a Bottle by placing a `cloudinabottle.toml` file at the root of their repository. For a walkthrough of building an app from scratch, see [Creating an App](creating_an_app.md).
